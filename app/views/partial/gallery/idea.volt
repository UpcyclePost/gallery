            ...
            <div class="thumbnail-container">
                ...
                <div class="overlay">
                    ...
                    <div class="btn-group share">
                        ...
                        <br>
                        <span class='st_twitter' st_via='Upmodinc' st_url="{{ url('gallery/' ~ _post['categoryTitle']|url ~ '/' ~ _post['title']|url ~ '-' ~ _post['ik']) }}" st_title="{{ _post['title'] }}" st_image="<?=Helpers::getImageUrl(sprintf('post/%s-%s.small.png', $_post['id'], $_post['ik']))?>"></span>
                        <br>
