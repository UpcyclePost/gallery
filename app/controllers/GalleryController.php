...
class GalleryController extends ControllerBase
{
	...
	public function indexAction($slug = false)
	{
		...
		$this->assets->addJs('js/gallery/layout.js?v=0.26.4')
	...
	public function viewAction($slug = false)
	{
		...
		$this->assets->addJs('js/gallery/view.js?v=0.26.4')
		             ->addJs('js/gallery/layout.js?v=0.26.4')
		             ->addJs('js/social/follow.js?v=0.26.4');
		...
		if ($this->auth && $this->auth !== false)
		{
			...
			{
				$this->assets->addJs('js/admin/gallery/view.js?v=0.26.4');
			}
